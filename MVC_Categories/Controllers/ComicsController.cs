...
namespace MVC_Categories.Controllers
{
    public class ComicsController : Controller
    {
        ...
        public ComicsController(MVC_CategoriesContext context)
        {
            _context = context;
        }
        ...
        {
            var mVC_CategoriesContext = _context.Comic.Include(c => c.Categoria);
            return View(await mVC_CategoriesContext.ToListAsync());
        }
